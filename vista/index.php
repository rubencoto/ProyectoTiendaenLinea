...
<head>
    ...
    <style>
        ...
        /* Custom Cart Button Styles - From Uiverse.io by vinodjangid07 - Adjusted for better layout */
        .cartBtn {
            width: 120px;
            height: 40px;
            border: none;
            ...
            box-shadow: 0 8px 15px -3px rgba(27, 27, 27, 0.3);
        ...
        .cartBtn:hover {
            ...
            text-decoration: none;
            transform: translateY(-2px);
            box-shadow: 0 12px 20px -3px rgba(27, 27, 27, 0.4);
        }
        ...
        /* From Uiverse.io by MuhammadHasann - Star Button Styles */
        .star-button {
            position: relative;
            padding: 12px 35px;
            background: #fec195;
